...
parameters.push(new graphSection('OT', 'https://coto-mobile.herokuapp.com/api/operate_time', -200, 4000, -600, 6000, 100));
parameters.push(new graphSection('RT', 'https://coto-mobile.herokuapp.com/api/release_time', -100, 2000, -400, 4000, 50));